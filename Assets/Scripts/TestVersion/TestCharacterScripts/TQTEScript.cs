...
public class TQTEScript : MonoBehaviour
{
    ...
    {
        Collider2D[] hitEnemies = Physics2D.OverlapCircleAll(attack.attackPoint.position, attack.attackRange, attack.enemyLayer);
